    ...
    public static Map<String, String> getParameterMap(HttpServletRequest request) {
        ...
        try {
            ...
            for (String key : keys) {
                ...
                source = request.getParameter(key).getBytes(Constant.DEFAULT_CHARSET);
                String value = new String(source, Constant.DEFAULT_CHARSET);
                resultMap.put(key, value);
            }
        } catch (UnsupportedEncodingException e) {
            log.error(ErrorCode.GET_REQUEST_PARAM_MAP_ERROR.getMessage(), e);
        }
        return resultMap;
    }
}
